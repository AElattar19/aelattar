        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="card-tools">
                    <a href="{{  route('upload.create') }}" class="btn btn-primary create add-permission">
                        <i class="ti-plus"></i> {{__('admin.NewAdmin')}}
                    </a>

                </div>
            </div>
            <div class="card-body" >
                <form id="massDeleteForm" action="{{ route('upload.massDelete') }}" method="POST">
                    @csrf
