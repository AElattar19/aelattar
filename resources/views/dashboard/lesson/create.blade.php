...
<div class="container-fluid">
    ...
    <!-- row -->
    <form method="post" enctype="multipart/form-data" action="{{ route('lesson.store') }}">
                                    ...
                                    <div class="panel-body tabs-menu-body main-content-body-right border-top-0 border">
                                        <div class="tab-content">
                                                    ...
                                                    <div class="row row-sm">
                                                        ...
                                                        <div class="col-lg-6 mg-b-20 mg-lg-b-0">
                                                            <p class="mg-b-10 required">youtube url</p>
                                                            <input class="form-control" id="Text input with radiobox" type="text" name="youtube"  required>
                                                        </div>
                                                    </div>
                                                    <div class="row row-sm">
                                                        <div class="col-lg-4 mg-b-20 mg-lg-b-0">
                                                            <p class="mg-b-10">Home</p>
                                                            <select name="home" id="status" class="form-control" >
